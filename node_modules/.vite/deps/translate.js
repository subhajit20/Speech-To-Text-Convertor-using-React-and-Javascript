...
var require_translate_min = __commonJS({
  "node_modules/translate/translate.min.js"(exports, module) {
    (function(global2, factory) {
      typeof exports === "object" && typeof module !== "undefined" ? module.exports = factory() : typeof define === "function" && define.amd ? define(factory) : global2.translate = factory();
    })(exports, function() {
      "use strict";
      ...
      function Cache() {
        ...
        this.put = function(key, value, time, timeoutCallback) {
          ...
          var record = { value, expire: time + Date.now() };
      ...
      var google = { fetch: ({ key, from, to, text }) => [`${base}?client=gtx&sl=${from}&tl=${to}&dt=t&q=${encodeURI(text)}`], parse: (res) => res.json().then((body) => {
        body = body && body[0] && body[0][0] && body[0].map((s) => s[0]).join("");
        if (!body)
          throw new Error("Translation not found");
        return body;
      }) };
      var yandex = { needkey: true, fetch: ({ key, from, to, text }) => [`https://translate.yandex.net/api/v1.5/tr.json/translate?key=${key}&lang=${from}-${to}&text=${encodeURIComponent(text)}`, { method: "POST", body: "" }], parse: (res) => res.json().then((body) => {
        if (body.code !== 200) {
      ...
      var libre = { needkey: false, fetch: ({ url = libreUrl, key, from, to, text }) => {
      ...
      var deepl = { needkey: true, fetch: ({ key, from, to, text }) => {
      ...
      const Translate = function(options = {}) {
        ...
        const defaults = { from: "en", to: "en", cache: void 0, languages, engines, engine: "google", keys: {} };
...
export default require_translate_min();
